...
public class ImageButtonHoverable extends Button {
    ...
    public ImageButtonHoverable(int pX, int pY, int pWidth, int pHeight, int pXTexStart, int pYTexStart, int pYDiffTex, ResourceLocation pResourceLocation, ResourceLocation pHoverLocation, int pTextureWidth, int pTextureHeight, OnPress pOnPress, OnTooltip pOnTooltip, Component pMessage) {
